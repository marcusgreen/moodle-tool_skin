...
$string['skinedit:upload'] = 'Upload a JSON file';
$string['skinedit:tag_required'] = 'Tag cannot be blank';
$string['skinedit:tag'] = 'Tag';
$string['skinedit:tag_help'] = 'Tag help';
$string['skinedit:cohort'] = 'Cohort';
$string['skinedit:cohort_help'] = 'Cohort help';
...
$string['skinedit:css_help'] = 'CSS without opening and clozing style tags. Ctrl-space will show popup help with syntax';
$string['skinedit:javascript'] = 'Javascript';
$string['skinedit:javascript_help'] = 'Javascript withoutout opening and closing script tags. calls to get_string will be converted as if this was PHP';
